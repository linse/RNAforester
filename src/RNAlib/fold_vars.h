...
extern bondT  *base_pair; /* vector of base pairs */
...
extern int    do_backtrace;     /* calculate pair prob matrix in part_func() */
extern int    noLonelyPairs;    /* avoid helices of length 1 */
extern char backtrace_type;     /* usually 'F'; 'C' require (1,N) to be bonded;
